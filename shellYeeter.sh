...
# NOTE: This tool might be disalowed in KOTH games that disallow automated user-removal [Check the rules first]

# Kills all bash shells, also thoses that are not user shells...
